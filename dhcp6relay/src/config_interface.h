 ...
 * 
 * @brief               initialize and get interface information from DHCP_RELAY
 *
 * @return              none
 */
 ...
 * @param context           map of interfaces/argument config that contains strings of server and option
 *
 * @return                  none
 */
