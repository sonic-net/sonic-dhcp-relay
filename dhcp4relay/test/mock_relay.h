...
extern std::unordered_map<std::string, std::string> interface_vrf_map;
...
extern std::unordered_map<std::string, std::string> circuit_id_interface_map;
extern std::vector<std::string> interface_list;
extern metadata_config m_config;
extern bool feature_dhcp_server_enabled;
extern std::unordered_map<std::string, relay_config> interfaces_copy;
